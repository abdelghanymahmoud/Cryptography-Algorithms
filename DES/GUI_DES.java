...
public class GUI_DES extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(GUI_DES.class.getName()).log(Level.SEVERE, null, ex);
        }

        GUI_DES frame = new GUI_DES();

        frame.setTitle("Data Encryption Standard");
    ...
    class Lis implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                ob = new DESKey(key.getText());
                ob1 = new DESEncrypt(ob);
                ob2 = new DESDecrypt(ob);
                if (e.getSource() == en_text) {
                    s = in.getText();
                    out.setText(ob1.encrpty(s));
                } else if (e.getSource() == de_text) {
                    s = in.getText();
                    out.setText(ob2.decrpty(s));
